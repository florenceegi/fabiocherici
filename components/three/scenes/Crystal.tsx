/**
 * @package fabiocherici.com — Crystal Scene
 * @author Padmin D. Curtis (AI Partner OS3.0) for Fabio Cherici
 * @version 1.0.0 (FlorenceEGI — fabiocherici.com)
 * @date 2026-05-15
 * @purpose Slowly rotating crystalline geometry with refraction and reflections. Ported from CREATOR-STAGING.
 */
  ...
  return (
    <group>
      <mesh ref={meshRef}>
        ...
        <meshPhysicalMaterial color="#e8d5c4" metalness={0.1} roughness={0.05} transmission={0.9} thickness={1.5} ior={2.4} transparent opacity={0.4} />
      </mesh>
      <mesh ref={innerRef}>
