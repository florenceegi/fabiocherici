/**
 * @package fabiocherici.com — NoiseTerrain Scene
 * @author Padmin D. Curtis (AI Partner OS3.0) for Fabio Cherici
 * @version 1.0.0 (FlorenceEGI — fabiocherici.com)
 * @date 2026-05-15
 * @purpose Generative landscape with moving dunes, top-down camera. Ported from CREATOR-STAGING.
 */
...
function Terrain() {
  ...
  return (
    <mesh ref={meshRef} geometry={geometry} rotation={[-Math.PI / 2.5, 0, 0]} position={[0, -3, 0]}>
      <meshStandardMaterial color="#8a7060" metalness={0.2} roughness={0.8} side={THREE.DoubleSide} />
    </mesh>
  );
}
