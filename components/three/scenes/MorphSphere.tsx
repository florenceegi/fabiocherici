/**
 * @package fabiocherici.com — MorphSphere Scene
 * @author Padmin D. Curtis (AI Partner OS3.0) for Fabio Cherici
 * @version 1.0.0 (FlorenceEGI — fabiocherici.com)
 * @date 2026-05-15
 * @purpose Sphere deforming with Perlin noise, iridescent surface, mouse reactive. Ported from CREATOR-STAGING.
 */
...
function Sphere() {
  ...
  return (
    <mesh ref={meshRef} geometry={geo}
      ...
      <meshStandardMaterial color="#c8a97e" metalness={0.7} roughness={0.2} />
    </mesh>
  );
}
