/**
 * @package fabiocherici.com — RibbonFlow Scene
 * @author Padmin D. Curtis (AI Partner OS3.0) for Fabio Cherici
 * @version 1.0.0 (FlorenceEGI — fabiocherici.com)
 * @date 2026-05-15
 * @purpose Silk ribbons flowing through 3D space, accent colored, mouse reactive. Ported from CREATOR-STAGING.
 */
...
function Ribbon({ index }: { index: number }) {
  ...
  const geometry = useMemo(() => {
    return new THREE.PlaneGeometry(12, 0.4, RIBBON_POINTS, 1);
  }, []);
